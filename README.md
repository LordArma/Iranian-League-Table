...
Advance display of the Iranian League One (Azadegan) table
```
...
```
[iran_league league="bartar" mode="advanced" title_backcolor="#212121" title_color="#ffffff" text_color="#212121" odd_color="#ffffff" even_color="#eeeeee" logo_size="" logo="true" title_font="13" text_font="14"]
```
